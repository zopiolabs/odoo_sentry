...
..
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This is a Zopio fork of the OCA sentry module for bug fixing !!
   !! and internal usage.                                          !!
   !! Original: https://github.com/OCA/server-tools/tree/15.0/sentry
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
.. |badge2| image:: https://img.shields.io/badge/licence-AGPL--3-blue.png
    ...
    :alt: License: AGPL-3
.. |badge3| image:: https://img.shields.io/badge/github-zopiolabs%2Fodoo__sentry-lightgray.png?logo=github
    :target: https://github.com/zopiolabs/odoo_sentry
    :alt: zopiolabs/odoo_sentry

|badge1| |badge2| |badge3|

**Zopio Fork Notice**

This is a Zopio fork of the `OCA sentry module <https://github.com/OCA/server-tools/tree/15.0/sentry>`_
for bug fixing and internal usage.
...
Bugs are tracked on `GitHub Issues <https://github.com/zopiolabs/odoo_sentry/issues>`_.
In case of trouble, please check there if your issue has already been reported.
If you spotted it first, help us to smash it by providing a detailed and welcomed
`feedback <https://github.com/zopiolabs/odoo_sentry/issues/new?body=module:%20zo_sentry%0Aversion:%2015.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.

For issues with the original OCA module, please report to `OCA/server-tools <https://github.com/OCA/server-tools/issues>`_.
...
* Original OCA module: https://github.com/OCA/server-tools/tree/15.0/sentry
* Vauxoo

Maintainers
~~~~~~~~~~~

This module is maintained by Zopio.

This is a fork of the OCA sentry module. The original module is maintained by the OCA.
...
This module is part of the `zopiolabs/odoo_sentry <https://github.com/zopiolabs/odoo_sentry>`_ project on GitHub.

Original OCA module: `OCA/server-tools <https://github.com/OCA/server-tools/tree/15.0/sentry>`_
